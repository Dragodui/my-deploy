...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\fAuthInternal\x12=\n" +
	"\fValidateUser\x12\x19.auth.ValidateUserRequest\x1a\x12.auth.UserResponseB<Z:github.com/dragodui/my-deploy/internal/shared/proto/authpbb\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthInternal.ValidateUser:input_type -> auth.ValidateUserRequest
	1, // 1: auth.AuthInternal.ValidateUser:output_type -> auth.UserResponse
